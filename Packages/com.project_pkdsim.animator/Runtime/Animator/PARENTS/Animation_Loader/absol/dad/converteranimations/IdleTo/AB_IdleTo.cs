using project_pkdsim.ANIMATOR.Parents.Absol.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.ANIMATOR.Parents.Absol.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.Parents.Absol.converteranimations.IdleTo
{
