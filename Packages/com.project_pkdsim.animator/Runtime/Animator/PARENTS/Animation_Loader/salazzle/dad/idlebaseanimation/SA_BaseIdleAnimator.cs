using project_pkdsim.ANIMATOR.Parents.Salazzle.Dad.idlebaseanimation.IdleSitting;
using project_pkdsim.ANIMATOR.Parents.Salazzle.Dad.idlebaseanimation.IdleStanding;
using UnityEngine;
