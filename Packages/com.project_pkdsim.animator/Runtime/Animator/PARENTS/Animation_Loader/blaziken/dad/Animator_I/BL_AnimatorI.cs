using project_pkdsim.ANIMATOR.Parents.Blaziken.Dad.idlebaseanimation;
using project_pkdsim.ANIMATOR.Parents.Blaziken.Dad.movementbasedanimations;
using project_pkdsim.ANIMATOR.Parents.Blaziken.Dad.converteranimations;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.Parents.Blaziken.Dad.Animator_I
{
