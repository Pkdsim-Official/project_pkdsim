using project_pkdsim.ANIMATOR.Parents.Espeon.Dad.idlebaseanimation.IdleSitting;
using project_pkdsim.ANIMATOR.Parents.Espeon.Dad.idlebaseanimation.IdleStanding;
using UnityEngine;
