using project_pkdsim.ANIMATOR.Parents.Umbreon.idlebaseanimation.IdleSitting;
using project_pkdsim.ANIMATOR.Parents.Umbreon.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.Parents.Umbreon.idlebaseanimation
{
