using project_pkdsim.ANIMATOR.Parents.Sylveon.Mom.movementbasedanimations.Jumping;
using project_pkdsim.ANIMATOR.Parents.Sylveon.Mom.movementbasedanimations.Running;
using project_pkdsim.ANIMATOR.Parents.Sylveon.Mom.movementbasedanimations.Strafing;
using project_pkdsim.ANIMATOR.Parents.Sylveon.Mom.movementbasedanimations.Turning;
using UnityEngine;
