using project_pkdsim.ANIMATOR.Parents.Primarina.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.ANIMATOR.Parents.Primarina.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.Parents.Primarina.converteranimations.IdleTo
{
