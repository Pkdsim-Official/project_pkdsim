using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.Animator_I
{
