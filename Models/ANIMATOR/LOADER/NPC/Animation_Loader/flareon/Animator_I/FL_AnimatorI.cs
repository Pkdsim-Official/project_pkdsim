using project_pkdsim.Assets.Models.ANIMATOR.NPC.Flareon.converteranimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Flareon.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Flareon.movementbasedanimations;
using UnityEngine;
