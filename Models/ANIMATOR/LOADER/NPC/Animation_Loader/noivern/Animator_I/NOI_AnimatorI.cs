using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.Animator_I
{
