using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.Animator_I
{
