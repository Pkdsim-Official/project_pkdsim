using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.idlebaseanimation
{
