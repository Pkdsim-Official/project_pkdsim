using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations
{
