using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations
{
