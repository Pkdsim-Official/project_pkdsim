using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations.SittingTo
{
