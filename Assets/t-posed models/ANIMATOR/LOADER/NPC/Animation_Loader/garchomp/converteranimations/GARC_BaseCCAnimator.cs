using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations
{
