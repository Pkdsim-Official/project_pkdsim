using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.movementbasedanimations
{
