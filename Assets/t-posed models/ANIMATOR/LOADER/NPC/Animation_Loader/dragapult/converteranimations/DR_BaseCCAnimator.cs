using project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.converteranimations
{
