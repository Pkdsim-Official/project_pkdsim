using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations
{
