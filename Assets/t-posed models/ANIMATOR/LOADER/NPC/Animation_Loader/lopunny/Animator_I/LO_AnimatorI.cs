using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lopunny.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lopunny.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lopunny.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Lopunny.Animator_I
{
