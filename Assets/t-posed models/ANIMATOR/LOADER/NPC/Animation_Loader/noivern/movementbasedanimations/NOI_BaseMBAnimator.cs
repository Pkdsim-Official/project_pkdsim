using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.movementbasedanimations
{
