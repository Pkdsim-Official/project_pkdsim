using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.SittingTo
{
