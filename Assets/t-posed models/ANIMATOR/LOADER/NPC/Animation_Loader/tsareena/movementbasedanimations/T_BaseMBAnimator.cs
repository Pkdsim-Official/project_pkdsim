using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.movementbasedanimations
{
