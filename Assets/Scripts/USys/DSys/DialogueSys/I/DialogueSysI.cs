using project_pkdsim.USys.DialogueSys.Modules.Load_Negative_Dialogue;
using project_pkdsim.USys.DialogueSys.Modules.Load_Neutral_Dialogue;
using project_pkdsim.USys.DialogueSys.Modules.Load_Positive_Dialogue;
using project_pkdsim.USys.DialogueSys.Modules.Load_Immune_Dialogue;
using project_pkdsim.USys.LoveSys.Modules.LoveScripts.AITEMS.Base.Affection_Score;
using TMPro;
using UnityEngine;

namespace project_pkdsim.USys.DialogueSys.Modules
{
