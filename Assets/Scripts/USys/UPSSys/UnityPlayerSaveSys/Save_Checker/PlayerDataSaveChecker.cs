...
namespace project_pkdsim.USys.UnityPlayerSaveSys.Save_Checker
{
	public class PlayerDataSaveChecker : MonoBehaviour
	{
		private class PData
		{
		...
		public void PlayerData_CheckerPanel()
		{
		...
		public void RunDataSaveChecker()
		{
			saveFilePath = Application.persistentDataPath + "/savegame.json"; // File path
			LoadPlayerData();
			PlayerData_CheckerPanel();  // Call the version checker
		}
	}
}
