...
using project_pkdsim.USys.LoveSys.Modules.LoveScripts.Affection.BASE;

namespace project_pkdsim.USys.LoveSys.Modules.LoveScripts.Modules.NPC.I_data.Meowscarada
{
