using project_pkdsim.ANIMATOR.Npcs.Salazzle.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.ANIMATOR.Npcs.Salazzle.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.USys.FailSafeSys.AnimatorFailSafeSys.ANIMATOR.NPC.Salazzle.converteranimations.IdleTo
{
