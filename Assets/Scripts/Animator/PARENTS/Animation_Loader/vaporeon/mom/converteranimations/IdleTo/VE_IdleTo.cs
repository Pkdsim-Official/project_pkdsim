...
namespace project_pkdsim.ANIMATOR.Parents.Vespiquen.Mom.converteranimations.IdleTo
{
	...
	{
		private VEParentMom_IdleToRun VaporeonParentMomIdleToRun;
		private VEParentMom_IdleToWalk VaporeonParentMomIdleToWalk;
		...
		{
			VaporeonParentMomIdleToRun.VEParentMom_IdleToRunController();
		}
		private void Load_VEParentMom_idleToWalk()
		{
			VaporeonParentMomIdleToWalk.VEParentMom_IdleToWalkController();
		}
	}
}