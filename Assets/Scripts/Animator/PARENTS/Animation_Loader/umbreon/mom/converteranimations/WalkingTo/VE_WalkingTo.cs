...
namespace project_pkdsim.ANIMATOR.Parents.Vespiquen.Mom.converteranimations.WalkingTo
{
	...
	{
		private VEParentMom_WalkingToSitting UmbreonParentMomWalkingToSitting;
		private VEParentMom_WalkingToStanding UmbreonParentMomWalkingToStanding;
		...
		{
			UmbreonParentMomWalkingToSitting.VEParentMom_WalkingToSittingController();
		}
		private void VEParentMom_WalkingToStanding()
		{
			UmbreonParentMomWalkingToStanding.VEParentMom_WalkingToStandingController();
		}
	}
}