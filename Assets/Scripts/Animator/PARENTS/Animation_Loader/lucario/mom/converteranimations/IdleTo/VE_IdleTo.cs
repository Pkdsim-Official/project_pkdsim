...
namespace project_pkdsim.ANIMATOR.Parents.Vespiquen.Mom.converteranimations.IdleTo
{
	...
	{
		private VEParentMom_IdleToRun LucarioParentMomIdleToRun;
		private VEParentMom_IdleToWalk LucarioParentMomIdleToWalk;
		...
		{
			LucarioParentMomIdleToRun.VEParentMom_IdleToRunController();
		}
		private void Load_VEParentMom_idleToWalk()
		{
			LucarioParentMomIdleToWalk.VEParentMom_IdleToWalkController();
		}
	}
}