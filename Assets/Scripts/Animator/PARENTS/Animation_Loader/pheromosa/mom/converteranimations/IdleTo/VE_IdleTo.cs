...
namespace project_pkdsim.ANIMATOR.Parents.Vespiquen.Mom.converteranimations.IdleTo
{
	...
	{
		private VEParentMom_IdleToRun PheromosaParentMomIdleToRun;
		private VEParentMom_IdleToWalk PheromosaParentMomIdleToWalk;
		...
		{
			PheromosaParentMomIdleToRun.VEParentMom_IdleToRunController();
		}
		private void Load_VEParentMom_idleToWalk()
		{
			PheromosaParentMomIdleToWalk.VEParentMom_IdleToWalkController();
		}
	}
}