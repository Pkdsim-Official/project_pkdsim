using project_pkdsim.ANIMATOR.Parents.Cinderace.Dad.idlebaseanimation.IdleSitting;
using project_pkdsim.ANIMATOR.Parents.Cinderace.Dad.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.Parents.Cinderace.Dad.idlebaseanimation
{
