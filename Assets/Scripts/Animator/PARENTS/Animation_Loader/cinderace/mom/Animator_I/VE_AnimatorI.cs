...
namespace project_pkdsim.ANIMATOR.Parents.Vespiquen.Animator_I
{
	public class LFS_VespiquenFailSafe : MonoBehaviour 
	{
		...
		private CinderaceParentMom_AnimatorBaseMovementController LFSCinderace_AnimatorCMA;
		...
		{
			LFSCinderace_AnimatorCCA.VEParentMom_ConverterToAnimatorController();
		}
		private void LoadFailSafeVespiquen_MovementAnimatorController()
		{
			LFSCinderace_AnimatorCMA.VEParentMom_MovementAnimatorController();
		}
		private void LoadFailSafeVespiquen_IdleAnimatorController()
		{
			LFSCinderace_AnimatorICA.VEParentMom_IdleAnimatorController();
		}
	}
}