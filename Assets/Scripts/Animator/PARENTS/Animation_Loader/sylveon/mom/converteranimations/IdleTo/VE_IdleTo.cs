...
namespace project_pkdsim.ANIMATOR.Parents.Vespiquen.Mom.converteranimations.IdleTo
{
	...
	{
		private VEParentMom_IdleToRun SylveonParentMomIdleToRun;
		private VEParentMom_IdleToWalk SylveonParentMomIdleToWalk;
		...
		{
			SylveonParentMomIdleToRun.VEParentMom_IdleToRunController();
		}
		private void Load_VEParentMom_idleToWalk()
		{
			SylveonParentMomIdleToWalk.VEParentMom_IdleToWalkController();
		}
	}
}