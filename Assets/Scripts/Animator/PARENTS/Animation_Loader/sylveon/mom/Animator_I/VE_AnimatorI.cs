...
namespace project_pkdsim.ANIMATOR.Parents.Vespiquen.Animator_I
{
	public class LFS_VespiquenFailSafe : MonoBehaviour 
	{
		...
		private SylveonParentMom_AnimatorBaseMovementController LFSSylveon_AnimatorCMA;
		...
		{
			LFSSylveon_AnimatorCCA.VEParentMom_ConverterToAnimatorController();
		}
		private void LoadFailSafeVespiquen_MovementAnimatorController()
		{
			LFSSylveon_AnimatorCMA.VEParentMom_MovementAnimatorController();
		}
		private void LoadFailSafeVespiquen_IdleAnimatorController()
		{
			LFSSylveon_AnimatorICA.VEParentMom_IdleAnimatorController();
		}
	}
}