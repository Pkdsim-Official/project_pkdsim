using project_pkdsim.Models.ANIMATOR.NPC.Braixen.idlebaseanimation.IdleSitting;
using project_pkdsim.Models.ANIMATOR.NPC.Braixen.idlebaseanimation.IdleStanding;
using UnityEngine;
