using project_pkdsim.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Jumping;
using project_pkdsim.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Running;
using project_pkdsim.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Strafing;
using project_pkdsim.Models.ANIMATOR.NPC.Noivern.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Noivern.movementbasedanimations
{
