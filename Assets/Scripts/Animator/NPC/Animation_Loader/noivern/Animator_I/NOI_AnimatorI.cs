using project_pkdsim.ANIMATOR.Npcs.Noivern.idlebaseanimation;
using project_pkdsim.ANIMATOR.Npcs.Noivern.movementbasedanimations;
using project_pkdsim.ANIMATOR.Npcs.Noivern.converteranimations;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.Npcs.Noivern.Animator_I
{
	public class LFS_NoivernFailSafe : MonoBehaviour 
	{
		...
		private Noivern_MovementAnimatorController LFSNoivern_AnimatorCMA;
