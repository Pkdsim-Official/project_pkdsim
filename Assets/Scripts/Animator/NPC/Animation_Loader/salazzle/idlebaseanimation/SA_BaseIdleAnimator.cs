using project_pkdsim.Models.ANIMATOR.NPC.Salazzle.idlebaseanimation.IdleSitting;
using project_pkdsim.Models.ANIMATOR.NPC.Salazzle.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Salazzle.idlebaseanimation
{
