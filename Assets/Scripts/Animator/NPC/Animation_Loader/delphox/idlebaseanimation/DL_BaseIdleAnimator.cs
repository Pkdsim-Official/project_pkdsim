using project_pkdsim.Models.ANIMATOR.NPC.Delphox.idlebaseanimation.IdleSitting;
using project_pkdsim.Models.ANIMATOR.NPC.Delphox.idlebaseanimation.IdleStanding;
using UnityEngine;
