using project_pkdsim.Models.ANIMATOR.NPC.Lucario.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Models.ANIMATOR.NPC.Lucario.movementbasedanimations.Turning.TurnRight;
using UnityEngine;
