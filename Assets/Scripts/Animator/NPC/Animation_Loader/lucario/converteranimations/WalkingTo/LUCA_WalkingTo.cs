using project_pkdsim.Models.ANIMATOR.NPC.Lucario.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Models.ANIMATOR.NPC.Lucario.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;
