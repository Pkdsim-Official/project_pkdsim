using project_pkdsim.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations.Turning.TurnRight;
using UnityEngine;
