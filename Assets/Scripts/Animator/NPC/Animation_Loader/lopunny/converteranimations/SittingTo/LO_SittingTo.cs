using project_pkdsim.Models.ANIMATOR.NPC.Lopunny.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Models.ANIMATOR.NPC.Lopunny.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Lopunny.converteranimations.SittingTo
{
