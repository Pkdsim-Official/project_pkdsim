using project_pkdsim.Models.ANIMATOR.NPC.Lopunny.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Models.ANIMATOR.NPC.Lopunny.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;
