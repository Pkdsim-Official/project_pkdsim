using project_pkdsim.ANIMATOR.NPC.Lunala.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.ANIMATOR.NPC.Lunala.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;
