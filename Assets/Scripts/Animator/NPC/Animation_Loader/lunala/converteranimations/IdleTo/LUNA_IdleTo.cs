using project_pkdsim.ANIMATOR.NPC.Lunala.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.ANIMATOR.NPC.Lunala.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;
