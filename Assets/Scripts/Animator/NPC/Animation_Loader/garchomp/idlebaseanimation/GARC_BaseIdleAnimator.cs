using project_pkdsim.ANIMATOR.Npcs.Garchomp.idlebaseanimation.IdleSitting;
using project_pkdsim.ANIMATOR.Npcs.Garchomp.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.Npcs.Garchomp.idlebaseanimation
{
