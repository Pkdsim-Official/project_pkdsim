using project_pkdsim.Models.ANIMATOR.NPC.Vaporeon.movementbasedanimations.Strafe.StrafeLeft;
using project_pkdsim.Models.ANIMATOR.NPC.Vaporeon.movementbasedanimations.Strafe.StrafeRight;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Vaporeon.movementbasedanimations.Strafe
{
