using project_pkdsim.Models.ANIMATOR.NPC.Sylveon.converteranimations.IdleTo;
using project_pkdsim.Models.ANIMATOR.NPC.Sylveon.converteranimations.SittingTo;
using project_pkdsim.Models.ANIMATOR.NPC.Sylveon.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Sylveon.converteranimations
{
