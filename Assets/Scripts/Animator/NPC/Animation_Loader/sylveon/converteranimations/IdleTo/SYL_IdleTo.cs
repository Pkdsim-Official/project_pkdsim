using project_pkdsim.Models.ANIMATOR.NPC.Sylveon.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Models.ANIMATOR.NPC.Sylveon.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Sylveon.converteranimations.IdleTo
{
