using project_pkdsim.Models.ANIMATOR.NPC.Pheromosa.idlebaseanimation.IdleSitting;
using project_pkdsim.Models.ANIMATOR.NPC.Pheromosa.idlebaseanimation.IdleStanding;
using UnityEngine;
