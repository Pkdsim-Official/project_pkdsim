using project_pkdsim.ANIMATOR.NPC.Absol.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.ANIMATOR.NPC.Absol.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.NPC.Absol.converteranimations.IdleTo
{
