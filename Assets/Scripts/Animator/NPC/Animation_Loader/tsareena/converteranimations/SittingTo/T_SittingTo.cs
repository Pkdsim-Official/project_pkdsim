using project_pkdsim.Models.ANIMATOR.NPC.Tsareena.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Models.ANIMATOR.NPC.Tsareena.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;
