using project_pkdsim.Models.ANIMATOR.NPC.Hatterene.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Models.ANIMATOR.NPC.Hatterene.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;
