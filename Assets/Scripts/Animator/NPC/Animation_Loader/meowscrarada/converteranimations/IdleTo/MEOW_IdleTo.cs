using project_pkdsim.ANIMATOR.NPC.Meowscarada.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.ANIMATOR.NPC.Meowscarada.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;
