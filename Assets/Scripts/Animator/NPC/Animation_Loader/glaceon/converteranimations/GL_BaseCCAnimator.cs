using project_pkdsim.Models.ANIMATOR.NPC.Glaceon.converteranimations.SittingTo;
using project_pkdsim.Models.ANIMATOR.NPC.Glaceon.converteranimations.WalkingTo;
using project_pkdsim.Models.ANIMATOR.NPC.Glaceon.converteranimations.IdleTo;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Glaceon.converteranimations
{
