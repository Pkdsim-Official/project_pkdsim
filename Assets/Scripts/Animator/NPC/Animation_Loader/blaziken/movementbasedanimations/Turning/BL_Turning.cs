using project_pkdsim.Models.ANIMATOR.NPC.Blaziken.movementbasedanimations.Turning.TurnLeft;
using project_pkdsim.Models.ANIMATOR.NPC.Blaziken.movementbasedanimations.Turning.TurnRight;
using UnityEngine;
