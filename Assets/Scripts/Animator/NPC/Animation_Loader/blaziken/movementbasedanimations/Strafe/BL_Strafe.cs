using project_pkdsim.Models.ANIMATOR.NPC.Blaziken.movementbasedanimations.Strafe.StrafeLeft;
using project_pkdsim.Models.ANIMATOR.NPC.Blaziken.movementbasedanimations.Strafe.StrafeRight;
using UnityEngine;
