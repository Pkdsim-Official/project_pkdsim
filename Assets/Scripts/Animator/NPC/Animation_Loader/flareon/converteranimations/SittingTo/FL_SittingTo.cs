using project_pkdsim.ANIMATOR.NPC.Flareon.converteranimations.SittingTo.SittingToStanding;
using project_pkdsim.ANIMATOR.NPC.Flareon.converteranimations.SittingTo.SittingToStartWalking;
using UnityEngine;

namespace project_pkdsim.ANIMATOR.NPC.Flareon.converteranimations.SittingTo
{
