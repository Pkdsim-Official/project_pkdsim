using project_pkdsim.Models.ANIMATOR.NPC.Flareon.converteranimations.SittingTo.SittingToStanding;
using project_pkdsim.Models.ANIMATOR.NPC.Flareon.converteranimations.SittingTo.SittingToStartWalking;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Flareon.converteranimations.SittingTo
{
