using project_pkdsim.Models.ANIMATOR.NPC.Flareon.idlebaseanimation.IdleSitting;
using project_pkdsim.Models.ANIMATOR.NPC.Flareon.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Models.ANIMATOR.NPC.Flareon.idlebaseanimation
{
