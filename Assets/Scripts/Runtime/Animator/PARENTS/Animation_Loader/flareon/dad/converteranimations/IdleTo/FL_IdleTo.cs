using Project_Pkdsim.ANIMATOR.Parents.Flareon.Dad.converteranimations.IdleTo.IdleToRun;
using Project_Pkdsim.ANIMATOR.Parents.Flareon.Dad.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;
