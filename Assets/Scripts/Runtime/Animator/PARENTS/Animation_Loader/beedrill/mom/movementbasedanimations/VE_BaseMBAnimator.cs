using Project_Pkdsim.ANIMATOR.Parents.Beedrill.Mom.movementbasedanimations.Jumping;
using Project_Pkdsim.ANIMATOR.Parents.Beedrill.Mom.movementbasedanimations.Running;
using Project_Pkdsim.ANIMATOR.Parents.Beedrill.Mom.movementbasedanimations.Strafing;
using Project_Pkdsim.ANIMATOR.Parents.Beedrill.Mom.movementbasedanimations.Turning;
using UnityEngine;

namespace Project_Pkdsim.ANIMATOR.Parents.Beedrill.Mom.movementbasedanimations
{
