...
namespace Project_Pkdsim.ANIMATOR.Npcs.Vespiquen.converteranimations.IdleTo.IdleToWalk
{
	public class VE_IdleToWalk : MonoBehaviour 
	{
		private Animator Vespiquen_Animator;
		public void VE_IdleToWalkController()
		{
