using Project_Pkdsim.ANIMATOR.Npcs.Jolteon.converteranimations.IdleTo.IdleToRun;
using Project_Pkdsim.ANIMATOR.Npcs.Jolteon.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace Project_Pkdsim.ANIMATOR.Npcs.Jolteon.converteranimations.IdleTo
{
