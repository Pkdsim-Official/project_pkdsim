...
using Project_Pkdsim.USys.LoveSys.Modules.LoveScripts.AITEMS.Base.Affection_Score.Positive;
using Project_Pkdsim.USys.LoveSys.Modules.LoveScripts.AITEMS.Base.Affection_Score.Neutral;
using Project_Pkdsim.USys.LoveSys.Modules.LoveScripts.AITEMS.Base.Affection_Score.Negative;
using UnityEngine;
using Project_Pkdsim.USys.LoveSys.Modules.LoveScripts.AITEMS.Base.Affection_Score.Immune;

namespace Project_Pkdsim.USys.LoveSys.Modules.LoveScripts.AITEMS.Base.Affection_Score
{
