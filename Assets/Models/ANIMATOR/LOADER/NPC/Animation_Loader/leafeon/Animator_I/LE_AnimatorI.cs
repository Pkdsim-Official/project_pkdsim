using project_pkdsim.Assets.Models.ANIMATOR.NPC.Leafeon.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Leafeon.converteranimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Leafeon.idlebaseanimation;
using UnityEngine;
