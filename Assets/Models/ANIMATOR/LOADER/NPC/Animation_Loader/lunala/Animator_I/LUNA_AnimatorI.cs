using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.Animator_I
{
