using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.converteranimations
{
