using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Lunala.movementbasedanimations
{
