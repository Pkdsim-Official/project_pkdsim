using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.converteranimations
{
