using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.Animator_I
{
