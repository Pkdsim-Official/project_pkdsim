using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Absol.idlebaseanimation
{
