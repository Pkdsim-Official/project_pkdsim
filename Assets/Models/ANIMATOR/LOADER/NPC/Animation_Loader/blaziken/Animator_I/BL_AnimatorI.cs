using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.Animator_I
{
