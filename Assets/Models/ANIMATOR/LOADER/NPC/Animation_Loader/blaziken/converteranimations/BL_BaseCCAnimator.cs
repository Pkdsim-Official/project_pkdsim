using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations
{
