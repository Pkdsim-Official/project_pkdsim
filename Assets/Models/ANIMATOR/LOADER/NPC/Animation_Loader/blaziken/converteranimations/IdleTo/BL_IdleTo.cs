using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Blaziken.converteranimations.IdleTo
{
