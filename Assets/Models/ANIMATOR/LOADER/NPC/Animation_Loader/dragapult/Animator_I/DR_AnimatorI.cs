using project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Dragapult.Animator_I
{
