using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations
{
