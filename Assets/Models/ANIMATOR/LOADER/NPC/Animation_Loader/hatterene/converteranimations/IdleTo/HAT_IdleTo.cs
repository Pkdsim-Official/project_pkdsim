using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations.IdleTo
{
