using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.movementbasedanimations
{
