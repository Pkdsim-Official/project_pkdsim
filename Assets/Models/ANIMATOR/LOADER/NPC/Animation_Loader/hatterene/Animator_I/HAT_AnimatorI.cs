using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Hatterene.Animator_I
{
