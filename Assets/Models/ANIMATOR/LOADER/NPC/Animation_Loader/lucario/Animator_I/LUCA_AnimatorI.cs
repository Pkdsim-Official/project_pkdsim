using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lucario.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lucario.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Lucario.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Lucario.Animator_I
{
