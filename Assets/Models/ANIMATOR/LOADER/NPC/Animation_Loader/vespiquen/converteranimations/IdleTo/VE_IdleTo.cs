using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations.IdleTo
{
