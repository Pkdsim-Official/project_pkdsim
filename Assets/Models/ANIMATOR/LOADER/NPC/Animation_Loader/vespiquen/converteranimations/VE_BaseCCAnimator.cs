using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations
{
