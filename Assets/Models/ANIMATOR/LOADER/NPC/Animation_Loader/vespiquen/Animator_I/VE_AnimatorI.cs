using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.Animator_I
{
