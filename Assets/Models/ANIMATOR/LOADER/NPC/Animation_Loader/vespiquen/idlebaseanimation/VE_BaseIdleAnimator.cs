using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Vespiquen.idlebaseanimation
{
