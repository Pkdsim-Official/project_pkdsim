using project_pkdsim.Assets.Models.ANIMATOR.NPC.Sylveon.converteranimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Sylveon.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Sylveon.movementbasedanimations;
using UnityEngine;
