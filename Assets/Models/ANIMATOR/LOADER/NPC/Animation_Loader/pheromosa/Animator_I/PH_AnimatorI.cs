using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.Animator_I
{
