using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Pheromosa.movementbasedanimations
{
