using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.movementbasedanimations
{
