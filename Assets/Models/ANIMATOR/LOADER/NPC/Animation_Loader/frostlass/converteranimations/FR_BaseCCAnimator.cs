using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Frostlass.converteranimations
{
