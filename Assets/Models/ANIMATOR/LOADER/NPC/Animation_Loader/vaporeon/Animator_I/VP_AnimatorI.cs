using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vaporeon.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vaporeon.converteranimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Vaporeon.movementbasedanimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Vaporeon.Animator_I
{
