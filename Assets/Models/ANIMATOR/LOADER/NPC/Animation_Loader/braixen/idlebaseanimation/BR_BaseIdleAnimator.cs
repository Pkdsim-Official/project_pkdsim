using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.idlebaseanimation
{
