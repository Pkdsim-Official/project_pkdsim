using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Braixen.converteranimations
{
