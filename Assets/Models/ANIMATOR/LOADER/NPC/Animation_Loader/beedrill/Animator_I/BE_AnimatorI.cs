using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.Animator_I
{
