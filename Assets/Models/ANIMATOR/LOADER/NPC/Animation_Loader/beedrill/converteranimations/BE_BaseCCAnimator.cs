using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Beedrill.converteranimations
{
