using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.movementbasedanimations
{
