using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.WalkingTo
{
