using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations.SittingTo
{
