using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Meowscarada.Animator_I
{
