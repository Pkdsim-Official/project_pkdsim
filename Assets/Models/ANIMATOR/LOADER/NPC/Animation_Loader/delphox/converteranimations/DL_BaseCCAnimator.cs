using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations
{
