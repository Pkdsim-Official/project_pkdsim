using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations.SittingTo.SittingToStartWalking;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations.SittingTo.SittingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations.SittingTo
{
