using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.idlebaseanimation
{
