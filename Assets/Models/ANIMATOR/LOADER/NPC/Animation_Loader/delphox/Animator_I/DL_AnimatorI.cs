using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Delphox.Animator_I
{
	public class LFS_DelphoxFailSafe : MonoBehaviour 
	{
		...
		private Delphox_AnimatorBaseMovementController LFSDelphox_AnimatorCMA;
