using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.Animator_I
{
