using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations
{
