using project_pkdsim.Assets.Models.ANIMATOR.NPC.Flareon.converteranimations.WalkingTo.WalkingToStanding;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations.WalkingTo.WalkingToSitting;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.converteranimations.WalkingTo
{
