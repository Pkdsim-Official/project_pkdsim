using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.idlebaseanimation.IdleSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.idlebaseanimation.IdleStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Tsareena.idlebaseanimation
{
