using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.Animator_I
{
