using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.movementbasedanimations
{
