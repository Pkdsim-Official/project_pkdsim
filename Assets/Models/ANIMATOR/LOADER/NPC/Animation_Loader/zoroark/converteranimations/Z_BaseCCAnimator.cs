using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Zoroark.converteranimations
{
