using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.Animator_I
{
