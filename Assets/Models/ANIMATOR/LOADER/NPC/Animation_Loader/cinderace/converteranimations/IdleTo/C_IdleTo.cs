using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Cinderace.converteranimations.IdleTo
{
