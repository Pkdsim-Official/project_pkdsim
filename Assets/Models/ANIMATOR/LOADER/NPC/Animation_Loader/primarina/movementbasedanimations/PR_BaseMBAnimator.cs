using project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.movementbasedanimations
{
