using project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Primarina.Animator_I
{
