using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.IdleTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.SittingTo;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.WalkingTo;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations
{
