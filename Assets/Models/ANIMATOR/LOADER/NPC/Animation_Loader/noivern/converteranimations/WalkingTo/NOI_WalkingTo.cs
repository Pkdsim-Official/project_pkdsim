using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Noivern.converteranimations.WalkingTo
{
