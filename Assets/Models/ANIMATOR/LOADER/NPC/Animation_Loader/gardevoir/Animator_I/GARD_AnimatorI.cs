using project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.Animator_I
{
