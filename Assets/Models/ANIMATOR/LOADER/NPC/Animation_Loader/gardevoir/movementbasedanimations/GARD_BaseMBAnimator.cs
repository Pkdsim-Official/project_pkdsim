using project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Gardevoir.movementbasedanimations
{
