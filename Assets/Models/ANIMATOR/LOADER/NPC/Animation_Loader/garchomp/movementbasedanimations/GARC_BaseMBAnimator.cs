using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.movementbasedanimations.Jumping;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.movementbasedanimations.Running;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.movementbasedanimations.Strafe;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.movementbasedanimations.Turning;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.movementbasedanimations
{
