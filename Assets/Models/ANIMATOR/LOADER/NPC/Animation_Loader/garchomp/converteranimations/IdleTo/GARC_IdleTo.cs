using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations.IdleTo.IdleToRun;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations.IdleTo.IdleToWalk;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations.IdleTo
{
