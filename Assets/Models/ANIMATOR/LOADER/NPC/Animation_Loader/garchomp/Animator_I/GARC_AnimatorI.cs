using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Garchomp.Animator_I
{
