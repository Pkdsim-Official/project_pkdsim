using project_pkdsim.Assets.Models.ANIMATOR.NPC.Salazzle.converteranimations.WalkingTo.WalkingToSitting;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Salazzle.converteranimations.WalkingTo.WalkingToStanding;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Salazzle.converteranimations.WalkingTo
{
