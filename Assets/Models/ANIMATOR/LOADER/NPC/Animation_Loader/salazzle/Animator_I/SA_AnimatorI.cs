using project_pkdsim.Assets.Models.ANIMATOR.NPC.Salazzle.idlebaseanimation;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Salazzle.movementbasedanimations;
using project_pkdsim.Assets.Models.ANIMATOR.NPC.Salazzle.converteranimations;
using UnityEngine;

namespace project_pkdsim.Assets.Models.ANIMATOR.NPC.Salazzle.Animator_I
{
